        ...
        <div class="container-fluid">
            ...
            <c:if test="${not empty success}">
                <div class="card card-register mx-auto mt-5">
                    <div class="card-body"><span style="color: lawngreen; font-weight: bold;">Pomyślnie dodano nowego klienta do bazy</span></div>
                </div>
            </c:if>

            <c:if test="${not empty error}">
                <div class="card card-register mx-auto mt-5">
                    <div class="card-body"><span style="color: red; font-weight: bold;">BŁĄD: nie dodano nowego klienta do bazy</span></div>
                </div>
            </c:if>
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-label-group">
                        <input type="date" name="birthdate" class="form-control" placeholder="Data urodzenia:" />
